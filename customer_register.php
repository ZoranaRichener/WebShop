						...
						<ul>
							...
							<ul id="cats">
								...
								<div id="content_area">
									...
									<?php cart(); ?>
									<div id="shopping_cart" style="width:800px;height:50px;background:black;">  
										<div id="shopping_cart"> 
											
											<span style="float:right; font-size:17px; padding:5px; line-height:40px; color:black">
												...
												<b style="color:yellow">Shopping Cart -</b> <b style='color:white'>Total Items: </b> <b style='color:white'><?php total_items(); ?></b><b style='color:white'>Total Price: </b> <a href="cart.php" style="color:yellow">Go to Cart</a>
										...
										<div class="container"> 
											...
											<form id="registration" action="customer_register.php" method="post" enctype="multipart/form-data">
												
												<table align="center" height="700" width="250">
